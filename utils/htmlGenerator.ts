  ...
  const mainImagesHtml = data.mainImages.map((img, index) => `
    <tr>
        <td align="center" style="padding:0; margin:0; line-height:0;">
            <img src="${img.url}" alt="${img.alt || `${data.title} - Image ${index + 1}`}" style="max-width:100%; height:auto; display:block; margin:0; padding:0;">
        </td>
    </tr>
  `).join('');
...
<div style="font-family: 'Verdana', sans-serif; color: #333; max-width: 1000px; margin: 0 auto; padding: 0; margin-bottom: 0;">
    <h2 style="padding: 0; margin: 0; text-align: center; max-width: 90%;">
    ...
    <table width="100%" cellspacing="0" cellpadding="0" border="0" align="center" style="margin:0; padding:0;">
        <tbody>
            ${mainImagesHtml}
        </tbody>
    </table>
    ...
    <!-- Comparison Table -->
    <div style="width:100%; margin:0 auto; padding:0; text-align:center; overflow-x:auto;">
        <table style="border-collapse:collapse; font-size:14px; text-align:center; width: 100%; min-width: 600px; margin:0; padding:0;">
            <tbody>
                <tr>
    ...
    <div style="max-width: 90%; margin: 0 auto; padding:0;">
